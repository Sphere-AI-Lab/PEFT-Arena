...
from peft_arena_verl.workers.rollout.async_server import async_server_class
...
class AgentLoopWorker:
    ...
    def get_agent_loop_class(self, agent_name: str) -> Type[AgentLoopBase]:
        ...
        from peft_arena_verl.experimental.agent_loop.single_agent_loop import SingleTurnAgentLoop
        from peft_arena_verl.experimental.agent_loop.tool_agent_loop import ToolAgentLoop
