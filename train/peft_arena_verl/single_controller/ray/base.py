...
from peft_arena_verl.single_controller.base import ClassWithInitArgs, ResourcePool, Worker, WorkerGroup
from peft_arena_verl.single_controller.base.decorator import MAGIC_ATTR, Dispatch
